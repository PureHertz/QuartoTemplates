...
% 更新履歴:
%   20260225:
%     - U+2212のマイナス記号を日本語処理されないように、\newunicodechar{−}{\textminus}を追加
%   20251212:
%     - lete-sans-mathのフォント名エラーを修正
%     - \maketitle内の\ifx閉じ忘れを修正
%   20250930:
...
\usepackage{newunicodechar}  % UTF-8文字をLaTeX文字に変換できるようにする
\newunicodechar{−}{\textminus}  % UTF-8のマイナス記号を日本語処理されないようにLaTeXのマイナス文字に変換
